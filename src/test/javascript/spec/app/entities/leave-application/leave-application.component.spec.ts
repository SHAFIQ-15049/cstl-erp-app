...
import { LeaveApplicationComponent } from 'app/entities/leave-application/leave-application.component';
...
describe('Component Tests', () => {
  describe('LeaveApplication Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.leaveApplications && comp.leaveApplications[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

...
describe('Component Tests', () => {
  describe('EducationalInfo Management Component', () => {
    let comp: EducationalInfoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EducationalInfoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.educationalInfos && comp.educationalInfos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

...
describe('Component Tests', () => {
  describe('EmployeeAccount Management Component', () => {
    let comp: EmployeeAccountComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EmployeeAccountComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.employeeAccounts && comp.employeeAccounts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

...
describe('Component Tests', () => {
  describe('EmployeeSalary Management Component', () => {
    let comp: EmployeeSalaryComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EmployeeSalaryComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.employeeSalaries && comp.employeeSalaries[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

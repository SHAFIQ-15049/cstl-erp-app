...
import { LeaveTypeComponent } from 'app/entities/leave-type/leave-type.component';
...
describe('Component Tests', () => {
  describe('LeaveType Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.leaveTypes && comp.leaveTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

...
import { ThanaComponent } from 'app/entities/thana/thana.component';
import { ThanaService } from 'app/entities/thana/thana.service';
import { Thana } from 'app/shared/model/thana.model';

describe('Component Tests', () => {
  describe('Thana Management Component', () => {
    let comp: ThanaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ThanaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.thanas && comp.thanas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

...
import { AdvanceComponent } from 'app/entities/advance/advance.component';
...
describe('Component Tests', () => {
  describe('Advance Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.advances && comp.advances[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

...
import { WeekendComponent } from 'app/entities/weekend/weekend.component';
import { WeekendService } from 'app/entities/weekend/weekend.service';
import { Weekend } from 'app/shared/model/weekend.model';

describe('Component Tests', () => {
  describe('Weekend Management Component', () => {
    let comp: WeekendComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(WeekendComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.weekends && comp.weekends[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

    ...
    val scn = scenario("Test the Vehicle entity")
        ...
        .repeat(2) {
            ...
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
                , "vehicleId":"SAMPLE_TEXT"
                , "type":"VEHICLE"
                , "classOfVehicle":"SAMPLE_TEXT"
                , "typeOfBody":"SAMPLE_TEXT"
                , "colour":"BLACK"
                , "numberOfCylinders":"ONE"
                , "engineNumber":"SAMPLE_TEXT"
                , "horsePower":"0"
                , "cubicCapacity":"0"
                , "noOfStandee":"SAMPLE_TEXT"
                , "unladenWeight":"0"
                , "prevRegnNo":"SAMPLE_TEXT"
                , "makersName":"SAMPLE_TEXT"
                , "makersCountry":"SAMPLE_TEXT"
                , "yearsOfManufacture":"0"
                , "chassisNumber":"SAMPLE_TEXT"
                , "fuelUsed":"OCTANE"
                , "rpm":"0"
                , "seats":"0"
                , "wheelBase":"0"

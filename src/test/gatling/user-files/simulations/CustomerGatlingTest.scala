    ...
    val scn = scenario("Test the Customer entity")
        ...
        .repeat(2) {
            ...
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
                , "fatherOrHusband":"SAMPLE_TEXT"
                , "address":"SAMPLE_TEXT"
                , "sex":"MALE"
                , "phoneNo":"SAMPLE_TEXT"
                , "nationality":"SAMPLE_TEXT"
                , "dateOfBirth":"2020-01-01T00:00:00.000Z"
                , "guardiansName":"SAMPLE_TEXT"
                , "chassisNo":"SAMPLE_TEXT"
                , "engineNo":"SAMPLE_TEXT"
                , "yearsOfMfg":"0"
                , "preRegnNo":"SAMPLE_TEXT"
                , "poOrBank":"SAMPLE_TEXT"
                , "voterIdNo":"SAMPLE_TEXT"
                , "voterIdAttachment":null
                , "passportAttachment":null
                , "birthCertificateAttachment":null
                , "gassOrWaterOrElectricityBill":null
                }""")).asJson
            .check(status.is(201))

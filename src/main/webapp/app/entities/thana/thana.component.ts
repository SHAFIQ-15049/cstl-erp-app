...
export class ThanaComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.thanaService
      ...
      .subscribe(
        (res: HttpResponse<IThana[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInThanas(): void {
    this.eventSubscriber = this.eventManager.subscribe('thanaListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IThana[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

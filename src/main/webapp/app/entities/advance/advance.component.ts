...
export class AdvanceComponent implements OnInit, OnDestroy {
  ...
  registerChangeInAdvances(): void {
    this.eventSubscriber = this.eventManager.subscribe('advanceListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IAdvance[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

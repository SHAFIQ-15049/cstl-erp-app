...
export class EducationalInfoComponent implements OnInit, OnDestroy {
  ...
  trackId(index: number, item: IEducationalInfo): number {
  ...
  delete(educationalInfo: IEducationalInfo): void {
    const modalRef = this.modalService.open(EducationalInfoDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.educationalInfo = educationalInfo;
  }

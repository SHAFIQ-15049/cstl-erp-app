...
export class DivisionComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.divisionService
      ...
      .subscribe(
        (res: HttpResponse<IDivision[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInDivisions(): void {
    this.eventSubscriber = this.eventManager.subscribe('divisionListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IDivision[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

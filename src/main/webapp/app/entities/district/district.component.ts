...
export class DistrictComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.districtService
      ...
      .subscribe(
        (res: HttpResponse<IDistrict[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInDistricts(): void {
    this.eventSubscriber = this.eventManager.subscribe('districtListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IDistrict[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

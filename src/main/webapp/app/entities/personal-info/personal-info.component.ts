...
export class PersonalInfoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.personalInfoService
      ...
      .subscribe(
        (res: HttpResponse<IPersonalInfo[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPersonalInfos(): void {
    this.eventSubscriber = this.eventManager.subscribe('personalInfoListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IPersonalInfo[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

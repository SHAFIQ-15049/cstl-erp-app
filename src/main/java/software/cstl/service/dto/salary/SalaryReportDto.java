...
public class SalaryReportDto {
    ...
    public String getRegularLeave() {
        return regularLeave;
    }

    public void setRegularLeave(String regularLeave) {
    ...
    public String getFestivalLeave() {
        return festivalLeave;
    }

    public void setFestivalLeave(String festivalLeave) {
    ...
    public void setTotalOverTimeSalary(String totalOverTimeSalary) {

...
public interface MonthlySalaryDtlRepository extends JpaRepository<MonthlySalaryDtl, Long>, JpaSpecificationExecutor<MonthlySalaryDtl> {
    List<MonthlySalaryDtl> findAllByMonthlySalary_YearAndMonthlySalary_MonthAndMonthlySalary_Designation_IdAndEmployee_Department_Id(Integer year, MonthType monthType, Long designationId, Long departmentId);

    List<MonthlySalaryDtl> findAllByMonthlySalary_YearAndMonthlySalary_MonthAndMonthlySalary_Designation_Id(Integer year, MonthType monthType, Long designationId);
